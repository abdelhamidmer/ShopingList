...
Item {
    ...
    FirebaseConfig {
        ...
        projectId: "shoppinglist-4133a"
        // TODO: update the database URL, from project_info | firebase_url
        databaseUrl: "https://shoppinglist-4133a-default-rtdb.firebaseio.com"

        // TODO: update the API keys for Android and/or iOS, from client | api_key | current_key
        apiKey: Qt.platform.os === "android" ? "AIzaSyCN4s7-KICcVVhxhtK9_VnQlCeZ0xTDwmU" : ""
        ...
        applicationId: Qt.platform.os
                       === "android" ? "1:486634686127:android:332804020b3f651df4365a" : ""
    }
    ...
    function saveShoppingItem(shoppingItem) {
        ...
        database.setUserValue(dbKeyAllShoppingItems + "/" + shoppingItem.date,
                              shoppingItem, loadingFinished)
    }
